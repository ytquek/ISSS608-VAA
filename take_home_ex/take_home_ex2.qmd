...
```{r}
pacman::p_load(tidyverse, scales, patchwork, ggtext, DT, plotly, ggplot2)
```
...
# Assuming combined_transaction already contains aggregated data
# If not, you would need to aggregate data as follows:
# combined_transaction <- combined_transaction %>%
#   group_by(Quarter, Property_Type) %>%
#   summarise(Transactions = n())
# Aggregate data to get the count of transactions per quarter and per property type
